...
public class MultiplexVideoDecoderFactory extends MediaCodecVideoDecoderFactory {
  ...
  public MultiplexVideoDecoderFactory() {
    this(null);
  }
   ...
   */
  public MultiplexVideoDecoderFactory(@Nullable EglBase.Context sharedContext) {
