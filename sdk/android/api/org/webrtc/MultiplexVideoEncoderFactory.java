...
public class MultiplexVideoEncoderFactory implements VideoEncoderFactory {
   ...
   */
  public MultiplexVideoEncoderFactory(
          EglBase.Context sharedContext, boolean enableH264HighProfile) {
    this(sharedContext, enableH264HighProfile,
   ...
   */
  public MultiplexVideoEncoderFactory(EglBase.Context sharedContext,
  ...
  @Deprecated
  public MultiplexVideoEncoderFactory(boolean enableIntelVp8Encoder, boolean enableH264HighProfile) {
  ...
  public VideoCodecInfo[] getSupportedCodecs() {
    ...
    for (VideoCodecType type :
            new VideoCodecType[] {VideoCodecType.H264}) {
