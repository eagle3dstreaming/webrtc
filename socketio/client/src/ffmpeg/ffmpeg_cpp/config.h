...
#define FFMPEG_CONFIGURATION "--disable-yasm --enable-shared --enable-ffplay --enable-debug=3 --disable-optimizations --disable-mmx --disable-stripping --enable-gpl --enable-nonfree --enable-libfdk-aac"
...
//Based on ffmpeg 3.3 definition 
//#define FF_API_PLUS1_MINUS1             (LIBAVUTIL_VERSION_MAJOR < 56)
#define FF_API_PLUS1_MINUS1 1
